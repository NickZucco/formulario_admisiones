                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <br><em>Por favor, tenga en cuenta que el archivo adjunto debe estar en formato PDF y no
                                tener
                        ...
                        <div class="col-md-6">
                            @if($candidate_info->ruta_adjunto_documento)
                                Archivo cargado previamente: <a
                                        href="{{env('APP_URL').$candidate_info->ruta_adjunto_documento}}"
                                        target="_blank">Documento</a>
                                <br><em>Por favor, tenga en cuenta que al cargar un nuevo archivo, se actualizará el
                                    archivo
