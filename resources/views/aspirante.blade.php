        ...
        <form method="post" action="{{ env('APP_URL') }}datos" class="form-horizontal" style="margin:20px 0"
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="apellido" name="apellido" placeholder=""
                               value="{{$candidate_info->apellido}}" required/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder=""
                               value="{{$candidate_info->nombre}}" required/>
                    </div>
                </div>
                <div class="form-group">
                    <label for="tipo_documento" class="col-md-2 col-sm-12 control-label">Tipo de documento de
                        identidad</label>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control" id="documento" name="documento" placeholder="##########"
                               value="{{$candidate_info->documento}}" required/>
                    </div>
                    <label for="ciudad_expedicion_documento" class="col-md-2 col-sm-12 control-label">Ciudad de
                        expedición</label>
                    <div class="col-md-2">
                        <input type="text" class="form-control" id="ciudad_expedicion_documento"
                               name="ciudad_expedicion_documento" placeholder=""
                               value="{{$candidate_info->ciudad_expedicion_documento}}" required/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input type="text" class=" datepicker2 maxToday form-control" id="fecha_nacimiento"
                               name="fecha_nacimiento" placeholder="####-##-##"
                               value="{{$candidate_info->fecha_nacimiento}}" required/>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control" id="direccion_residencia" name="direccion_residencia"
                               placeholder="" value="{{$candidate_info->direccion_residencia}}" required>
                    </div>
                    <label for="ciudad_aplicante" class="col-md-2 control-label">Ciudad desde la cual aplica</label>
                    <div class="col-md-2">
                        <input type="text" class="form-control" id="ciudad_aplicante" name="ciudad_aplicante"
                               placeholder="" value="{{$candidate_info->ciudad_aplicante}}" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="number" class="form-control" id="telefono_fijo" name="telefono_fijo"
                               placeholder="#######" value="{{$candidate_info->telefono_fijo}}" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        <input type="number" class="form-control" id="telefono_movil" name="telefono_movil"
                               placeholder="#######" value="{{$candidate_info->telefono_movil}}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="correo" class="col-sm-2 control-label">Correo electrónico</label>
                    <div class="col-sm-10">
                        <input type="email" class="form-control" id="_correo" name="_correo" placeholder=""
                               value="{{$correo}}" readonly disabled>
                    </div>
                </div>
                <div class="form-group">
                    <label for="adjunto" class="col-sm-12 col-md-2 control-label">Documento de identidad
                        (obligatorio): </label>
                    <div class="col-sm-12 col-md-4">
                        <input id="adjunto" type="file" class="form-control" name="adjunto_documento" required>
                        <br><em>Por favor, tenga en cuenta que el archivo adjunto debe estar en formato PDF y no tener
                            un tamaño superior a 10MB</em>
                    </div>
                    <div class="col-md-6">
                        @if($candidate_info->ruta_adjunto_documento)
                            Archivo cargado previamente: <a
                                    href="{{env('APP_URL').$candidate_info->ruta_adjunto_documento}}" target="_blank">Documento</a>
                            <br><em>Por favor, tenga en cuenta que al cargar un nuevo archivo, se actualizará el archivo
                                previamente cargado</em>
                        @endif
                    </div>
                </div>
                <div class="form-group">
                    <label for="adjunto" class="col-sm-12 col-md-2 control-label">Tarjeta profesional
                        (opcional): </label>
                    <div class="col-sm-12 col-md-4">
                    ...
                    <div class="col-md-6">
                        @if($candidate_info->ruta_adjunto_tarjetaprofesional)
                            Archivo cargado previamente: <a
                                    href="{{env('APP_URL').$candidate_info->ruta_adjunto_tarjetaprofesional}}"
                                    target="_blank">Tarjeta profesional</a>
                            <br><em>Por favor, tenga en cuenta que al cargar un nuevo archivo, se actualizará el archivo
                                previamente cargado</em>
                        @endif
                    </div>
