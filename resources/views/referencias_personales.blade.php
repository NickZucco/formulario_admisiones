    ...
    <div class="panel panel-default">
        ...
        <form method="post" action="{{ env('APP_URL') }}datos" class="form-horizontal" style="margin:20px 0"
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="inconvenientes" class="control-label col-md-12">Por favor adicione comentarios que indiquen si
                        ...
                        Posgrado</label>
                    <div class="col-md-12">
                        <textarea name="inconvenientes" id="inconvenientes" cols="50" rows="5" class="form-control"></textarea>
                    </div>
                </div>
            </div>
